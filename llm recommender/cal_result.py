...
for dataset_name in dataset_names:
    ...
    root_path = '/content/drive/MyDrive/EC523DL/RecRanker/RecRanker/conventional recommender/dataset'
    ...
    for modelname in model_names:
        ...
        idd = '1'
        kk = 5
        gt_list = pd.read_csv(f'{root_path}/{dataset_name}/model_result/{modelname}gt_save_dict{idd}.csv', header=None,
                              names=['u', 'i'])

        rec_list = pd.read_csv(f'{root_path}/{dataset_name}/model_result/{modelname}rec_save_dict{idd}.csv', header=None,
        ...
        ran_list = pd.read_csv(f'{root_path}/{dataset_name}/my_test_list{modelname}.txt',
        ...
        with open(f'{root_path}/{dataset_name}/test_ml-100k_MF_pairwise.jsonl',
                  'r') as f:
            lines = f.readlines()

        with open(f'{root_path}/{dataset_name}/test_ml-100k_MF_pairwise_inv.jsonl',
                  'r') as f:
            lines2 = f.readlines()
        ...
        # print(f"pairwise ranking: {pair_str}")
        print(point_str,f'\n{pair_str}\n{list_str}\n{hybird_str}')
        print('-' * 34)